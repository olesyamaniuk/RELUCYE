document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-t-navigation-list");
  const headerRef = document.querySelector(".q-t-header");
  const navigationRef = document.querySelector(".q-t-navigation");
